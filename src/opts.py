...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--pa_model', default='',
                                 help='path to pa model')
        self.parser.add_argument('--pa_fuse_mode', default='',
                                 help='mode to fuse pa: ')
        self.parser.add_argument('--rgb_w3', default=0.7,
    ...
    def parse(self, args=''):
        ...
        if opt.rgb_model != '':
            ...
            opt.save_dir = opt.save_root + opt.pa_model
